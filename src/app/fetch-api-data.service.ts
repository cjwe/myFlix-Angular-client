...
export class GetMovieByTitleService {
  ...
  private handleError(error: HttpErrorResponse): any {
    ...
    return throwError(
      'Something went wrong loading the selected movie; please try again later.'
    );
  }
}
...
export class GetGenreService {
  ...
  private handleError(error: HttpErrorResponse): any {
    ...
    return throwError(
      'Something went wrong loading the selected genre; please try again later.'
    );
  }
}
...
export class GetDirectorService {
  ...
  private handleError(error: HttpErrorResponse): any {
    ...
    return throwError(
      'Something went wrong loading the selected director; please try again later.'
    );
  }
}
...
export class GetUserService {
  ...
  private handleError(error: HttpErrorResponse): any {
    ...
    return throwError(
      'Something went wrong loading user; please try again later.'
    );
  }
}
...
export class GetUserFavoritesService {
  ...
  private handleError(error: HttpErrorResponse): any {
    ...
    return throwError(
      'Something went wrong loading favorites; please try again later.'
    );
  }
}
...
export class AddUserFavoritesService {
  ...
  private handleError(error: HttpErrorResponse): any {
    ...
    return throwError(
      'Something went wrong adding movie to favorites; please try again later.'
    );
  }
}
...
export class EditUserService {
  ...
  private handleError(error: HttpErrorResponse): any {
    ...
    return throwError(
      'Something went wrong when trying to edit user; please try again later.'
    );
  }
}
...
export class DeleteUserService {
  ...
  private handleError(error: HttpErrorResponse): any {
    ...
    return throwError(
      'Something went wrong when trying to delete user; please try again later.'
    );
  }
}

// Delete user's favorite movie
export class DeleteUserFavoriteService {
  constructor(private http: HttpClient) {}
  deleteUser(): Observable<any> {
    return this.http
